...
URLKernel='https://raw.githubusercontent.com/wongsyrone/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/root/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/wongsyrone/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "http://serverspeeder.azurewebsites.net/lic?mac=${MAC}&bandwidth=1000M"
...
{
[ ! -f /root/appex.zip ] && wget --no-check-certificate -q -O "/root/appex.zip" "https://raw.githubusercontent.com/wongsyrone/serverSpeeser_Install/master/appex.zip"
